...
function BetaAccessForm() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 bg-brand-navy">
      <div className="w-full max-w-sm bg-brand-blue border border-brand-gold/40 rounded-xl shadow-sm p-8">
        <div className="flex justify-center mb-4">
          <svg width="32" height="32" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M14 2L4 7V14C4 19.5 8.5 24.7 14 26C19.5 24.7 24 19.5 24 14V7L14 2Z" fill="#C8943A" stroke="#D4A045" strokeWidth="1.5"/>
