  ...
  return (
    <div ref={containerRef} className="relative">
      <input
        ...
        className={`w-full px-3 py-2 border rounded-lg text-sm bg-brand-navy text-brand-heading placeholder-brand-body/40 focus:outline-none focus:ring-2 focus:border-transparent ${
          hasError
